...
import com.ly.rshypoc.util.FragmentChangeManager;
import com.ly.rshypoc.util.OnTabSelectListener;
import com.ly.rshypoc.util.UnreadMsgUtils;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mTextUnSelectSize = ta.getDimension(R.styleable.CommonTabLayout_tl_textUnSelectSize, -1);
        ...
        if (mTextUnSelectSize < 0) {
            mTextUnSelectSize = mTextsize;
        }
        ta.recycle();
    }
