package com.ly.rshypoc.share.screen;
...
public class RecordService extends IntentService {
    ...
    private void initView() {
        ...
        if (inflater != null) {
            ...
            view.findViewById(R.id.ll_floating_window_menu).setOnTouchListener(new FloatingOnTouchListener());
            view.findViewById(R.id.iv_gomain_layout).setOnTouchListener(new FloatingOnTouchListener());
            ...
            //                        layoutParams.x += (int) (x - lastX) / 3; // 减小偏移量,防止过度抖动
            //                        layoutParams.y += (int) (y - lastY) / 3; // 减小偏移量,防止过度抖动
            //                        tag = 1;
    ...
    //                    int newOffsetY = layoutParams.y;
    //                    // 只要按钮一动位置不是很大,就认为是点击事件
    //                    if (Math.abs(x - newOffsetX) <= 20
    //                            && Math.abs(y - newOffsetY) <= 20) {
    //                        v.performClick();
    //                    }
    ////                    if (view.getId() == R.id.ll_floating_window_menu || view.getId() == R.id.iv_gomain_layout) {
    ////
    ////                    }
    //
    //                    break;
