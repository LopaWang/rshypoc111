...
public class BlinkLayout extends LinearLayout {
    ...
    public BlinkLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.BlinkLayout, 0, 0);

        try {
            shimmerAnimationDuration = a.getInteger(R.styleable.BlinkLayout_blink_animation_duration, 4000);
